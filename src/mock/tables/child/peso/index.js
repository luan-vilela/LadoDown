import { TABELA_PESO_MASCULINO } from './masculino';
import { TABELA_PESO_FEMININO } from './feminino';

const percentis = ['p3', 'p10', 'p25', 'p50', 'p75', 'p90', 'p97'];
const cors = ['black', 'red', 'orange', 'green', 'orange', 'red', 'black'];

export const table_peso_child = sexy => {
  const conjuntosDeDados = [];

  const table = sexy === 'M' ? TABELA_PESO_MASCULINO : TABELA_PESO_FEMININO;
